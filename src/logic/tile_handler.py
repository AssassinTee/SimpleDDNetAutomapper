from globals import NUM_NEIGHBOR_BITS, EIGHT_NEIGHBORS
...
class TileHandler():
    ...
    def _init(self):
        # Tile Storage:
        # contains encoded neighborship relation and points to Tile, can have multiple tiles
